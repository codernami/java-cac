...
public class Datos extends javax.swing.JFrame implements ActionListener{
    ...
    public Datos(){
        ...
        dia = new JLabel("Día");
        dia.setBounds(170,130,150,50);
        add(dia);
        
        mes = new JLabel("Mes");
        mes.setBounds(255,130,150,50);
        add(mes);
        
        anio = new JLabel("Año");
        anio.setBounds(345,130,150,50);
        add(anio);
        ...
        dir.setBounds(80,450,150,50);
        add(dir);
        
        calle = new JLabel("Calle: ");
        calle.setBounds(80,485,150,50);
        add(calle);
        
        nro = new JLabel("N°: ");
        nro.setBounds(80,528,150,50);
        add(nro);
        
        piso = new JLabel("Piso: ");
        piso.setBounds(180,528,150,50);
        add(piso);
        
        dpto = new JLabel("Dpto: ");
        dpto.setBounds(280,528,150,50);
        add(dpto);
        
        loc = new JLabel("Localidad: ");
        loc.setBounds(80,565,150,50);
        add(loc);
        ...
        txtCalle.setBounds(120,500,320,25);
        add(txtCalle);
        
        txtNro = new JTextField();
        txtNro.setBounds(105,540,50,25);
        add(txtNro);
    
        txtPiso = new JTextField();
        txtPiso.setBounds(215,540,30,25);
        add(txtPiso);
        
        txtDpto = new JTextField();
        txtDpto.setBounds(320,540,30,25);
        add(txtDpto);
        
        txtLoc = new JTextField();
        txtLoc.setBounds(145,580,295,25);
        add(txtLoc);
        ...
        btnA.setBounds(150,650,90,30);
        add(btnA);
        btnA.addActionListener(this);
    
        btnS= new JButton("Salir");
        btnS.setBounds(290,650,90,30);
        add(btnS);
